...
[![Build Status](https://github.com/baobab-platform/baobab-dev/actions/workflows/publish.yml/badge.svg)](https://github.com/baobab-platform/baobab-dev/actions/workflows/publish.yml)
[![Latest Release](https://img.shields.io/github/v/release/baobab-platform/baobab-dev?label=Release)](https://github.com/baobab-platform/baobab-dev/releases)
[![Container Registry](https://img.shields.io/badge/GitHub%20Container%20Registry-GHCR-2ea44f?logo=github)](https://github.com/baobab-platform/baobab-dev/pkgs/container/baobab-dev)
...
```bash
git clone https://github.com/baobab-platform/baobab-dev.git
cd baobab-dev
```
...
📖 **Documentation:** https://baobab-platform.github.io/baobab-dev/
...
This repository dogfoods `ghcr.io/baobab-platform/baobab-dev:1.4.3`. Its SHA-pinned
